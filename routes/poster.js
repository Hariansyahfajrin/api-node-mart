...
router.post('/', asyncHandler(async (req, res) => {
    try {
        uploadPosters.single('img')(req, res, async function (err) {
            ...
            let imageUrl = 'no_url';
            if (req.file) {
                imageUrl = `https://4271-2001-448a-1109-16cf-c888-ccc7-1336-8bee.ngrok-free.app/image/poster/${req.file.filename}`;
            }
...
router.put('/:id', asyncHandler(async (req, res) => {
    try {
        ...
        uploadPosters.single('img')(req, res, async function (err) {
            ...
            if (req.file) {
                image = `https://4271-2001-448a-1109-16cf-c888-ccc7-1336-8bee.ngrok-free.app/image/poster/${req.file.filename}`;
            }
